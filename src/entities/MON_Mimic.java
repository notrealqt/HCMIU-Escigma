...
public class MON_Mimic extends Entity {
    ...
    public void getImage(){
        ...
        up5 = setUp(path + "up0",gp.tileSize, gp.tileSize);
        up6 = setUp(path + "up1",gp.tileSize, gp.tileSize);
        up7 = setUp(path + "up2",gp.tileSize, gp.tileSize);
        ...
        down5 = setUp(path + "down0",gp.tileSize, gp.tileSize);
        down6 = setUp(path + "down1",gp.tileSize, gp.tileSize);
        down7 = setUp(path + "down2",gp.tileSize, gp.tileSize);
        ...
        left5 = setUp(path + "left0",gp.tileSize, gp.tileSize);
        left6 = setUp(path + "left1",gp.tileSize, gp.tileSize);
        left7 = setUp(path + "left2",gp.tileSize, gp.tileSize);
        ...
        right5 = setUp(path + "right0",gp.tileSize, gp.tileSize);
        right6 = setUp(path + "right1",gp.tileSize, gp.tileSize);
        right7 = setUp(path + "right2",gp.tileSize, gp.tileSize);
    }
